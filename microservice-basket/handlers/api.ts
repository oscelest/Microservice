...
new Endpoint<object, object, Endpoint.UUIDLocals>("/:uuid", Endpoint.Method.GET, (request, response) => Basket.findById(request, response));
...
new Endpoint<object, Basket.UpdateRequestBody, Endpoint.UUIDLocals>("/:uuid", Endpoint.Method.PUT, (request, response) => Basket.update(request, response));
new Endpoint<object, Basket.SetProductRequestBody, Endpoint.UUIDLocals>("/:uuid/product", Endpoint.Method.POST, (request, response) => Basket.setProduct(request, response));
